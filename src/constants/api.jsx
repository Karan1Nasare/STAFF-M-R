const URLS = {
  ...
  GET_CHAPTER_MATERIAL: subjectId => `/get-chapters/${subjectId}`,
  STUDENT_ATTENDANCE_UPDATE: 'student-attendance/store-update',
  STUDENT_ATTENDANCE_STORE: 'student-attendance/store-update',
  STUDENTS: '/students',
