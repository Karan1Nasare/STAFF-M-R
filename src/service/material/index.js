...
export const updateMaterialContent = async (formData, params) => {
  console.log('🚀 ~ updateMaterialContent ~ params:', params);
  console.log('🚀 ~ updateMaterialContent ~ formData:', formData);
  return axiosInstance.post(URLS.EDIT_CONTENT_BY_ID(params), formData);
};

export const updateMaterialContent2 = async (formData, params) => {
  return axiosInstance.post(URLS.EDIT_CONTENT_BY_ID(params), formData);
};
