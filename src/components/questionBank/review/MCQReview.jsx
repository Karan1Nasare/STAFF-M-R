    ...
    <div className='flex-shrink-0' key={index}>
      ...
      {[
        ...
        <div className='flex mb-4' key={idx}>
          <input
            className='custom-checkbox mr-6 mt-3 rounded h-5 w-5 border border-zinc-400 text-green-600 bg-gray-100 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600'
            type='checkbox'
            checked={idx === question.question_right_ans - 1}
            value={idx + 1}
            readOnly
          />
          <div
            className={`w-28.8 h-2.6 px-3 rounded ${idx === question.question_right_ans - 1 ? 'bg-bright_green' : 'bg-blue'} justify-start items-center gap-4 inline-flex`}
          >
