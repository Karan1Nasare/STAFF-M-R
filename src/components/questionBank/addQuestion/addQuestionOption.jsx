  ...
  return (
    <div className='mt-4'>
      <div className='flex ml-[10%] mt-6'>
        <button
          className={`w-36 h-9 text-xs mr-5 rounded-sm bg-primary text-orange__primary  hover:text-success hover:bg-success hover:bg-opacity-15 ${selectedQuestionType === 'question' ? 'bg-success bg-opacity-15 text-success' : 'text-orange bg-orange bg-opacity-15'}`}
