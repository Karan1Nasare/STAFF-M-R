...
const AddQuestionTab = () => {
  ...
  const questionSchema = yup.object().shape({
    ...
    option: yup.string().when('question_type', {
      is: val => val === 'TF',
      then: schema => schema.required('True or False answer is required'),
    }),
  });
  ...
  const questionListForm = useForm({
    ...
    defaultValues: { questions: [defaultAddQuestion] },
  });
  ...
  console.log('getValues', getValues(), watch());
